...
electron = require('electron-connect').server.create(port : 30081)
__srcdir = './src/'
__distdir = './dist/'
...
gulp.task 'watch', ['jade', 'coffee', 'cjsx', 'less', 'top'], () ->
  electron.start()
  gulp.watch __srcdir + '**/*.jade', ['jade']
  gulp.watch __srcdir + 'css/*.less', ['less']
  # gulp.watch __srcdir + 'js/**/*.{jsx, js}', ['es6']
